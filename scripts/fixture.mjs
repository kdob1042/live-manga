...
const poster2=await make('poster-2','color=c=0xE3E8E9:s=278x430',278,430);
...
const video=await make('motion',"color=c=0xE3E8E9:s=278x430:r=24[bg];color=c=0x27343C:s=54x54:r=24[box];[bg][box]overlay=x='110+45*sin(t*2)':y='120+75*cos(t*1.6)':shortest=1",278,430,true);
const panels=[
 {id:'panel-1',frame:{x:26,y:26,width:470,height:470},artRect:{x:26,y:26,width:470,height:470},poster:poster1,text:'静かな午後。'},
 {id:'panel-2',frame:{x:496,y:26,width:278,height:470},artRect:{x:496,y:26,width:278,height:430},poster:poster2,text:'ひとつのコマに、触れてみる。',motion:{asset:video,end:'poster'}},
